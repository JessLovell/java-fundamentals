...
public class AppTest {
    ...
    @Test public void testEmptyMain() {

        String[] args = {};
        App.main(args);
        assertEquals("Oops! Something went wrong. Read the docs for more information\n", outContent.toString());
    }

    @Test public void testInvertMain() {

        String[] args2 = {"test.bmp", "test_invert_after.bmp", "invert"};
        App.main(args2);
        assertEquals("Success! Your image was inverted.\n", outContent.toString());
    }

    @Test public void testFlipVertMain(){

        String[] args2 = {"test.bmp", "test_vert_after.bmp", "flipVertically"};
        App.main(args2);
        assertEquals("Success! Your image was flipped vertically.\n", outContent.toString());
    }

    @Test public void testFlipHorMain(){

        String[] args2 = {"test.bmp", "test_hor_after.bmp", "flipHorizontally"};
        App.main(args2);
        assertEquals("Success! Your image was flipped horizontally.\n", outContent.toString());
    }

    @Test public void testRandomMain(){

        String[] args2 = {"test.bmp", "test_rand_after.bmp", "randomize"};
        App.main(args2);
        assertEquals("Success! Your image was randomized.\n", outContent.toString());
    }

    @Test public void testLasttMain(){

        String[] args2 = {"test.bmp", "test_main_after.bmp", "misspelled"};
        App.main(args2);
        assertEquals("misspelled is not available.\n", outContent.toString());
    }
